    ...
    if route_df.empty:
        ...
        for mcs in sorted(route_df["MCS"].unique()):
            ...
            row_html.append(
                ...
                "<table><thead><tr><th>순서</th><th>충전소</th><th>시간대</th><th>도착</th><th>서비스시작</th><th>서비스종료</th><th>발생비율(%)</th></tr></thead>"
...
<table>
<thead><tr><th>요일</th><th>K</th><th>Status</th><th>Covered events</th><th>Covered profit</th><th>Profit ratio</th><th>MIP gap</th><th>Runtime sec</th><th>하루 전체 지도</th><th>시간대별 지도</th><th>타임라인</th></tr></thead>
<tbody>
{''.join(rows)}
</tbody>
</table>
...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", default=r"C:\Users\82109\PyCharmMiscProject\종설_LRP\results_hourly_timeline", help="Directory for output CSV/HTML files")
