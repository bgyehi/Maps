...
from dispatching_6 import *   # SPT, EDD, ILS, VNS 포함
...
for prob_file in instance_files:
    ...
    inst_ils = deep_copy_solution(inst_spt)
    ...
    inst_vns = deep_copy_solution(inst_spt)
...
df.to_csv("results_SPT_EDD_ILS_VNS.csv")
print("\nSaved results_SPT_EDD_ILS_VNS.csv ✅")
