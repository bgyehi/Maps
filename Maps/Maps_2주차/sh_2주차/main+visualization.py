...
if __name__ == "__main__":
    ...
    template_html = os.path.join(base_dir, "PMSP_SDST_Optimal.html")
    output_html = os.path.join(base_dir, "result_schedule.html")
    ...
    result.save_schedule_html_from_template(
